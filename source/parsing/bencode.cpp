...
bencode::item_bencode::parse_byte_string(buffer const& s,size& idx){
    // Check for leading zeros: if the first digit is '0', the next char must be ':'
...
bencode::item_bencode::parse_integer(buffer const& s,size& idx){
